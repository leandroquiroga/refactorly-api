...
class Settings(BaseSettings):
    ...
    GEMINI_API_KEY: str = Field(...,  min_length=1, validation_alias=("GOOGLE_API_KEY"), description="Gemini API Key")
    DEEPSEEK_API_KEY: str = Field(..., min_length=1, validation_alias=("DEEPSEEK_API_KEY"), description="Deepseek API Key")
